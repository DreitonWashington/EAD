...
public class UserNotificationController {
    ...
    public ResponseEntity<Page<NotificationDomain>> getAllNotificationsByUser(@PathVariable(value = "userId")UUID userId,
        ...
        List<NotificationDomain> allNotifications = notificationServicePort.findAllNotificationByUser(userId,pageInfo);
        return ResponseEntity.status(HttpStatus.OK).body(new PageImpl<NotificationDomain>(allNotifications, pageable, allNotifications.size()));
    }
    ...
    public ResponseEntity<Object> updateNotification(@PathVariable(value = "userId")UUID userId,
        ...
        Optional<NotificationDomain> notificationModelOptional = notificationServicePort.findByNotificationIdAndUserId(
